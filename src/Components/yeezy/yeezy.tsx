        ...
        <div className="yeezy_container">
          ...
          <div className="yeezy_desc-wrapper">
            <h3 className="yeezy_desc">
                ...
                the incorporation <p>of</p> <p>advanced</p> <p>technologies</p><p>...</p>
            </h3>
          </div>
          ...
          <div className="yeezy_pboots_container">
            ...
            <li className="yeezy_pboots">
              <img src="../../Images/yeezy_boots/yeezy350_onyx.jpg" className="yeezy_pboots_img yeezy_pboots_img-first" />
            </li>

            <li className="yeezy_pboots">
              <img src="../../Images/yeezy_boots/yeezy350_onyx.jpg" className="yeezy_pboots_img yeezy_pboots_img-second" />
            </li>

            <li className="yeezy_pboots">
              <img src="../../Images/yeezy_boots/yeezy350_onyx.jpg" className="yeezy_pboots_img yeezy_pboots_img-third" />
            </li>
            </ul>
          </div>
